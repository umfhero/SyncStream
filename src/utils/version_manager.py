...
class VersionManager:
            ...
            try:
                if not self.latest_release_info:
                    if completion_callback:
                        completion_callback(False, "No update information available")
                    return
                    ...
                    for chunk in response.iter_content(chunk_size=8192):
                        if chunk:
                            ...
                            if total_size > 0 and progress_callback:
                                ...
                                progress_callback("download", f"Downloading... {downloaded/1024/1024:.1f}MB", percent)
                ...
                self._install_update(extract_dir, backup_dir, progress_callback)
                ...
                if completion_callback:
                    completion_callback(True, "Update installed successfully! Please restart SyncStream.")
    ...
    def _install_update(self, extract_dir: str, backup_dir: str, progress_callback=None):
        ...
        exclude_patterns = ['.git', '__pycache__', '*.pyc', '.syncstream', 'backup']
